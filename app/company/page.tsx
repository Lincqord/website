...
export const metadata: Metadata = {
  title: "会社概要 | Lincqord",
  description:
    "株式会社リンクォード（Lincqord）の会社概要。ミッション・ビジョン、Difference（違い）の考え方、会社情報。CQ（文化知性）を軸に“違い”をチカラにする組織づくりを支援します",
};
    ...
    <main className="flex-1">
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-3xl px-5 lg:px-8 text-center">
          ...
          <p className="mt-24 font-display tracking-[0.2em] text-brand-orange text-lg">
            VISION
          </p>
          ...
          <Link href="/cq"
            className="mt-12 inline-block text-sm font-500 text-brand-teal hover:text-brand-teal-deep underline underline-offset-4"
          >
            CQ（文化知性）とは →
          </Link>
        </div>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-3xl px-5 lg:px-8 text-center">
          ...
          <p className="mt-4 text-base lg:text-lg leading-relaxed text-muted">
            組織とは、私たちのDifferenceのぶつかり合い。
          </p>
          <p className="mt-4 text-base lg:text-lg leading-relaxed text-muted">
            &ldquo;あなた自身&rdquo;を中心に、違いは幾重もの層で重なり合っています
          </p>
